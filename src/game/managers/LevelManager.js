...
export class LevelManager {
    ...
    createPlatformsGrass() {
        ...
        platformGrassPositions.forEach((pos) => {
            const platformGrass = this.platformGrassGroup.create(
                pos.x,
                pos.y,
                "platform-grass"
            );
    ...
    createPlatformsWood() {
        ...
        platformWoodPositions.forEach((pos) => {
            const platformWood = this.platformWoodGroup.create(
                pos.x,
                pos.y,
                "platform-wood"
            );
    ...
    createPlatformsStone() {
        ...
        platformStonePositions.forEach((pos) => {
            const platformStone = this.platformStoneGroup.create(
                pos.x,
                pos.y,
                "platform-stone"
            );
    ...
    createWallsStone() {
        ...
        wallStonePositions.forEach((pos) => {
            const wallStone = this.wallStoneGroup.create(
                pos.x,
                pos.y,
                "wall-stone"
            );
    ...
    createSpikesBottom() {
        ...
        spikesLeftPositions.forEach((pos) => {
            const spikesBottom = this.spikesBottomGroup.create(
                pos.x,
                pos.y,
                "spikes-bottom"
            );
    ...
    createSpikesTop() {
        ...
        spikesTopPositions.forEach((pos) => {
            const spikesTop = this.spikesTopGroup.create(
                pos.x,
                pos.y,
                "spikes-top"
            );
    ...
    createSpikesRight() {
        ...
        spikesRightPositions.forEach((pos) => {
            const spikesRight = this.spikesRightGroup.create(
                pos.x,
                pos.y,
                "spikes-right"
            );
    ...
    createBoxesWumpaFruits() {
        ...
        boxWumpaFruitPositions.forEach((pos) => {
            const boxWumpaFruit = this.boxWumpaFruitGroup.create(
                pos.x,
                pos.y,
                "box-wumpa_fruits"
            );
    ...
    explodeTNT(tnt) {
        ...
        this.scene.enemies?.forEach((enemy) => {
            ...
            if (
                distance < tntExplosionRadius &&
                typeof enemy.kill === "function"
            ) {
                enemy.kill();
            }
        });
    ...
    smashWumpaFruitBox(box) {
        ...
        for (let i = 0; i < fruitCount; i++) {
            ...
            const fruit = this.fruitGroup.create(
                box.x + offsetX,
                box.y + offsetY,
                "wumpa_fruit"
            );
    ...
    createFruits() {
        ...
        fruitPositions.forEach((pos) => {
            const wumpa_fruit = this.fruitGroup.create(
                pos.x,
                pos.y,
                "wumpa_fruit"
            );
