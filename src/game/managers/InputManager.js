export class InputManager {
    constructor(scene) {
        ...
        this.keys = {
            ...
            leftArrow: scene.input.keyboard.addKey(
                Phaser.Input.Keyboard.KeyCodes.LEFT
            ),
            right: scene.input.keyboard.addKey(
                Phaser.Input.Keyboard.KeyCodes.D
            ),
            rightArrow: scene.input.keyboard.addKey(
                Phaser.Input.Keyboard.KeyCodes.RIGHT
            ),
            jump: scene.input.keyboard.addKey(
                Phaser.Input.Keyboard.KeyCodes.SPACE
            ),
            jumpArrow: scene.input.keyboard.addKey(
                Phaser.Input.Keyboard.KeyCodes.UP
            ),
            jumpW: scene.input.keyboard.addKey(
                Phaser.Input.Keyboard.KeyCodes.W
            ),
            spin: scene.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.E),
            // Add pause keys
            pause: scene.input.keyboard.addKey(
                Phaser.Input.Keyboard.KeyCodes.ESC
            ),
            pauseP: scene.input.keyboard.addKey(
            ...
            select: scene.input.keyboard.addKey(
